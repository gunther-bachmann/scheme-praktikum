...
*** Wie halte ich diese Infos zusammen
    ...
    #+end_src
    Mit diesem Befehl sagen wir Racket, dass wir eine /Struktur/ mir dem Namen /figur/ beschreiben, die zweit Informationen über die Figur
    zusammen halten soll, nämlich die zu verwendende Kachel oder auch Bild und die Position auf der diese Figur auf dem Spielbrett
    erscheinen soll.
